...
<head>
    ...
    <title>Sửa thông tin giỏ hàng chi tiết</title>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Sửa thông tin giỏ hàng chi tiết</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Sửa thông tin giỏ hàng chi tiết</h3></strong>
                    </div>

                </div>
                <div class="card-body">
                    <sf:form action="/gio-hang-ct/sua/${gioHangCT.id}" method="post" modelAttribute="gioHangCT" class="row">
                        <div class="col-lg-6" style="margin-top: 20px;">
                            Mã Sản Phẩm CT (<i class="fa fa-asterisk" style="color: red;"></i>)
                            <sf:select path="sanPhamCT.id" name="IdSanPhamCT" class="form-control">
                                <c:forEach items="${dsSanPhamCT}" var="sanPhamCT" varStatus="spct">
                                    <option <c:if test="${gioHangCT.sanPhamCT.id == sanPhamCT.id}">selected="selected"</c:if>   value="${sanPhamCT.id}" >${sanPhamCT.ma}</option>
                                </c:forEach>
                            </sf:select>
                            <sf:errors path="sanPhamCT.id" cssClass="text-danger" />
                        </div>

                        <div class="col-lg-6" style="margin-top: 20px;">
                            Mã giỏ hàng (<i class="fa fa-asterisk" style="color: red;"></i>)
                            <sf:select path="gioHang.id" name="IdGioHang" class="form-control">
                                <c:forEach items="${dsGioHang}" var="gioHang" varStatus="giohang">
                                    <option <c:if test="${gioHangCT.gioHang.id == gioHang.id}">selected="selected"</c:if>   value="${gioHang.id}" >${gioHang.ma}</option>
                                </c:forEach>
                            </sf:select>
                            <sf:errors path="gioHang.id" cssClass="text-danger" />
                        </div>
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            ...
                            <sf:input path="donGia" name="donGia" type="text" class="form-control" />
                        ...
                        <div class="col-lg-6" style="margin-top: 20px;">
                            ...
                            <sf:input path="soLuong" name="soLuong" type="text" class="form-control" />
                        ...
                        <div class="col-lg-3 ml-auto" style="margin-top: 20px;">
                            ...
                            <a href="/gio-hang-ct/hien-thi" class="btn btn-secondary"> <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
