...
<head>
    ...
    <title>Sửa đợt khuyến mãi</title>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Sửa thông tin đợt khuyến mãi</h3></strong>
                    </div>
                ...
                <div class="card-body">
                    <sf:form action="/dot-khuyen-mai/sua/${dotKhuyenMai.id}" method="post" modelAttribute="dotKhuyenMai" class="row">
                        ...
                        <div class="col-lg-3" style="margin-top: 20px; ">
                            ...
                            <a href="/dot-khuyen-mai/hien-thi" class="btn btn-secondary" > <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
