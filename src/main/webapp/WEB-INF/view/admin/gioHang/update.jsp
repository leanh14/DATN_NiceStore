                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active">Sửa thông tin giỏ hàng</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="animated fadeIn">
            <div class="card col-lg-12">
                <div class="card-header">
                    <div>
                        <strong class="card-title" ><h3>Sửa thông tin giỏ hàng</h3></strong>
                    </div>

                </div>
                <div class="card-body">
                    <sf:form action="/gio-hang/sua/${gioHang.id}" method="post" modelAttribute="gioHang" class="row">
                        <div class="col-lg-6" style="margin-top: 20px;">
                            ...
                            <sf:select path="khachHang.id" name="IdKhachHang" class="form-control">
                                <c:forEach items="${dsKhachHang}" var="khachHang" varStatus="chucvu">
                                    <option <c:if test="${gioHang.khachHang.id == khachHang.id}">selected="selected"</c:if>   value="${khachHang.id}" >${khachHang.ten}</option>
                                </c:forEach>
                            </sf:select>
                        ...
                        <div class="col-lg-3 ml-auto" style="margin-top: 20px;">
                            ...
                            <a href="/gio-hang/hien-thi" class="btn btn-secondary"> <i class="menu-icon fa fa-undo"></i> Quay lại</a>
                        </div>
                    </sf:form>
